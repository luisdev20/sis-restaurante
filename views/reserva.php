...
<head>
    ...
    <title>Reserva | Brasa Bros</title>
    <link rel="stylesheet" href="../public/assets/styles/reserva.css">
</head>
<body>
    <header>
        <h1>Reserva tu mesa en Brasa Bros</h1>
    </header>
    <main>
        ...
        <form action="../src/controllers/ReservaController.php" method="POST">
            ...
            <input type="number" id="invitados" name="invitados" min="1" required>
