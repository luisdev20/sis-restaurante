...
<head>
    ...
    <title>Dashboard | BrasaBros Admin</title>
...
<div class="admin-wrapper">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="index.php?page=admin-dashboard" class="nav-item active">
        ...
        <main class="page-body">
            ...
            <div class="date-card">
                <div class="date-info">
                    ...
                    <strong>domingo, 22 de febrero de 2026</strong>
                </div>
                <div class="status-badge">
                    <small>Estado</small>
                    <span class="badge-operativo">Operativo</span>
                </div>
            </div>
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    <div class="stat-info">
                        ...
                        <div class="stat-number"><?= $en_preparacion ?></div>
                    </div>
                ...
                <div class="stat-card">
                    <div class="stat-info">
                        <label>Reservas Registradas</label>
                        <div class="stat-number"><?= $reservas_registradas ?></div>
                    </div>
