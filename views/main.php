  ...
  <body>
    <header class="header">
      <div class="logo_contenedor">
        <a href="main.php"
          ><img
            src="../public/assets/images/logo_pollo.png"
            alt="Logo Brasa Bros"
            class="logo_imagen"
        /></a>
      ...
      <nav class="menu">
        ...
        <a href="reserva.php" class="nav-reserva"
          >Promociones</a
        >
      </nav>
    </header>
    ...
    <main>
      <section class="hero">
        <div class="hero-contenido">
          ...
          <a href="reserva.php" class="btnReservacion"
            >RESERVACIÓN</a
          >
        </div>
      </section>
    ...
    <section class="multimedia">
      ...
      <video controls width="100%" poster="../public/assets/images/video_pollo.jpg">
        <source src="../public/assets/videos/video_restaurante.mp4" type="video/mp4" />
      </video>

      <p>Escucha el sonido del sabrosura:</p>
      <audio controls>
        <source src="../public/assets/audio/audio-papas.mp3" type="audio/mpeg" />
      </audio>
    </section>
    ...
    <section class="ubicacion">
      <div class="ubicacion-info">
        ...
        <a
          href="https://www.google.com/maps?q=Av.+Principal+123,+Ciudad+Brasa"
          target="_blank"
          class="ubicacion-link"
        >
          <img src="../public/assets/images/maps.png" alt="Google Maps" class="icono-maps" />
      ...
      <div class="pagos">
        ...
        <div class="pagos-iconos">
          ...
          <img src="../public/assets/images/yape.png" alt="Yape" />
          <img src="../public/assets/images/plin.png" alt="Plin" />
        </div>
      </div>
    </section>
  </body>
