...
<body>
  ...
  <main>
    ...
    <section class="delivery-info">
      <img src="assets/images/Pollo-a-la-braza-4-1.jpg" alt="Pollo a la brasa" />
    ...
    <section class="promociones">
      ...
      <div class="productos">
        <div class="producto">
          <img src="assets/images/polloalabrasa4k.jpg" />
          <h3>Combo Festín</h3>
        ...
        <div class="producto">
          <img src="assets/images/PolloPersonal.png" />
        ...
        <div class="producto">
          <img src="assets/images/ParrillaRe.png" />
          <h3>Lomo Real</h3>
        ...
        <div class="producto">
          <img src="assets/images/ParrillaPersonal.png" />
        ...
        <div class="producto">
          <img src="assets/images/ParrillaPollo.png" />
    ...
    <section class="formulario" id="formulario">
      ...
      <form action="index.php?action=delivery" method="POST">
        <input type="hidden" id="producto-hidden" name="producto" value="">
    ...
    <script>
      ...
      for (var i = 0; i < productos.length; i++) {
        productos[i].onclick = function () {
          ...
          document.getElementById("producto-hidden").value = nombre;
